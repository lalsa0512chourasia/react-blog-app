        ...
        <div className='the_latest'>
            ...
            <div className='main_ArtAll'>
                <div className='box_1' >
                    ...
                    <img src='https://news-decoder.com/wp-content/uploads/2021/11/greenland3-scaled.jpg' alt='My Awesome' />
                    <div className='box_1cont'>
                        ...
                        <p> Here we are hiking on the ice cap at sunset. Two days before our hike, it rained for the first time in history on the summit of the inland ice,
                            according to the U.S. National Snow and Ice Data Center.</p>
                        <p><strong>Climate</strong><span>/ Jan 22</span></p>
                    </div>
                </div>

                <div className='box_2'>
                    <img src='https://www.financialexpress.com/wp-content/uploads/2021/06/10-2.jpg' alt='My Awesome' />
                    <div className='box_2cont'>
                        ...
                        <p>Yoga is the most favourable method to connect to the nature by balancing the mind-body connection. It is a type of exercise which performed through the balanced body and need to get control over diet, breathing.</p>
                        <p><strong>Fitness</strong><span>/ Jan 22</span></p>
                    </div>
                </div>
                <div className='box_3'>
                    ...
                    <div className='box_3cont'>
                        ...
                        <p>When you eat food with your family and friends, it always tastes better!
                            Everything tastes good when you're hungry.Everybody loves to eat and enjoy with family !! Yummy !! Online available</p>
                        <p><strong>Food</strong><span>/ Jan 22</span></p>
                    </div>
                </div>
            </div>
