...
const LatestArtCat1 = () => {
    return (
        <div className='maincat1'>
            ...
            <img src='https://images.unsplash.com/photo-1479920252409-6e3d8e8d4866?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTI5fHx0ZWNobm9sb2d5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60' alt='My Awesome'/>
            <div className='cat1box_1p'>
                <h3>Popularity</h3>

                <span>High Usage - Online training, e-learning, education, academics, scholarship, knowledge, online-education.</span><br />
